...
{
    public class AdmiMezunController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(tblKisis.ToList());
        }

        // GET: AdmiMezun/Details/5
